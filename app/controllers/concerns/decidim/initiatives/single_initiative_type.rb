...
module Decidim
  module Initiatives
    ...
    module SingleInitiativeType
      ...
      included do
        helper_method :single_initiative_type?, :current_organization_initiatives_type

        private

        def current_organization_initiatives_type
          @current_organization_initiatives_type ||= Decidim::InitiativesType.where(organization: current_organization)
        end
